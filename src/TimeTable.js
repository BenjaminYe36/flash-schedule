...
export default class TimeTable extends Component {
    ...
    static getDerivedStateFromProps(props) {
        if (props.timeZone === 'PST') {
            return {
                localTime: ['8:30', '9:00', '9:30', '10:00', '10:30', '11:00', '11:30', '12:00', '12:30', '13:00', '13:30', '14:00', '14:30', '15:00', '15:30', '16:00', '16:30', '17:00', '17:30', '18:00', '18:30', '19:00', '19:30', '20:00'],
                localDay: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday']
            };
        }
        if (props.timeZone === 'CST') {
            return {
                localTime: ['0:30', '1:00', '1:30', '2:00', '2:30', '3:00', '3:30', '4:00', '4:30', '5:00', '5:30', '6:00', '6:30', '7:00', '7:30', '8:00', '8:30', '9:00', '9:30', '10:00', '10:30', '11:00', '11:30', '12:00'],
